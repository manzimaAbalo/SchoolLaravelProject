            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-danger rounded-pill px-4" data-bs-dismiss="modal"> Discard
                        </button>
                    </div>
                </div>
            </div>
                ...
                <table class="table search-table align-middle text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="/admin/dist/images/profile/user-2.jpg" alt="avatar"
                                        class="rounded-circle" width="35" />
                                    <div class="ms-3">
                                        <div class="user-meta-info">
                                            <h6 class="user-name mb-0" data-name="Olivia Allen">Olivia Allen
                                            </h6>
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="/admin/dist/images/profile/user-3.jpg" alt="avatar"
                                        class="rounded-circle" width="35" />
                                    <div class="ms-3">
                                        <div class="user-meta-info">
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="/admin/dist/images/profile/user-4.jpg" alt="avatar"
                                        class="rounded-circle" width="35" />
                                    <div class="ms-3">
                                        <div class="user-meta-info">
                                            <h6 class="user-name mb-0" data-name="Amelia Armstrong"> Amelia
                                                Armstrong </h6>
                                            <span class="user-work fs-3"
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="/admin/dist/images/profile/user-5.jpg" alt="avatar"
                                        class="rounded-circle" width="35" />
                                    <div class="ms-3">
                                        <div class="user-meta-info">
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <div class="user-meta-info">
                                            <h6 class="user-name mb-0" data-name="Sofia Bailey">Sofia Bailey
                                            </h6>
                                            <span class="user-work fs-3"
                                                data-occupation="UX/UI Designer">UX/UI Designer</span>
                                        </div>
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <div class="user-meta-info">
                                            <h6 class="user-name mb-0" data-name="Victoria Sharma"> Victoria
                                                Sharma </h6>
                                            <span class="user-work fs-3"
                                                data-occupation="Project Manager">Project Manager</span>
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <div class="user-meta-info">
                                            <h6 class="user-name mb-0" data-name="Penelope Baker"> Penelope
                                                Baker </h6>
                                            <span class="user-work fs-3" data-occupation="Web Developer">Web
                                                Developer</span>
                                        </div>
